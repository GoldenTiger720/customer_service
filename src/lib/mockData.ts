...
export const mockCases: Case[] = [
  {
    ...
    description:
      "Customer reports that their premium product order was delayed by 5 days without prior notification.",
    type: "complaint",
    status: "in_progress",
    priority: "high",
  ...
  },
  {
    ...
    description:
      "Customer suggests adding dark mode to the mobile application.",
    type: "suggestion",
    status: "resolved",
    priority: "low",
  ...
  },
  {
    ...
    description:
      "Customer believes they were overcharged on their last invoice.",
    type: "complaint",
    status: "pending",
    priority: "urgent",
    customer: mockCustomers[0],
...
export const mockCampaigns: LoyaltyCampaign[] = [
  {
    ...
    description:
      "Special offers for premium customers who have been with us for over 2 years",
    status: "active",
